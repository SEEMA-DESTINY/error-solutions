...
<!--end::Pre-loader-->
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed ">
        ...
        {{-- <a href="{{ route('dashboard') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/sidebar.png') }}" class="w-25" />
        </a> --}}
        <a href="#">
            <img alt="Logo" src="{{ asset('assets/media/logos/sidebar.png') }}" class="w-25" />
        </a>
    ...
    <!-- begin::User Panel-->
    @include('layout.sections.user-panel')
    @include('layout.sections._socket-notify')
    <!-- end::User Panel-->
    ...
    <!--end::Scrolltop-->
    @include('layout.sections.modal')
    @include('layout.sections.script')
</body>
<!--end::Body-->
